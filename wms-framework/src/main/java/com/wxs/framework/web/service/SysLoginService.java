package com.wxs.framework.web.service;

import cn.hutool.core.util.RandomUtil;
import com.wxs.common.constant.Constants;
import com.wxs.common.core.domain.entity.SysRole;
import com.wxs.common.core.domain.entity.SysUser;
import com.wxs.common.core.domain.model.ExtraUserBody;
import com.wxs.common.core.domain.model.LoginUser;
import com.wxs.common.core.redis.RedisCache;
import com.wxs.common.exception.ServiceException;
import com.wxs.common.exception.user.CaptchaException;
import com.wxs.common.exception.user.CaptchaExpireException;
import com.wxs.common.exception.user.UserException;
import com.wxs.common.exception.user.UserPasswordNotMatchException;
import com.wxs.common.utils.DateUtils;
import com.wxs.common.utils.MessageUtils;
import com.wxs.common.utils.SecurityUtils;
import com.wxs.common.utils.ServletUtils;
import com.wxs.common.utils.ip.IpUtils;
import com.wxs.framework.manager.AsyncManager;
import com.wxs.framework.manager.factory.AsyncFactory;
import com.wxs.system.service.ISysConfigService;
import com.wxs.system.service.ISysRoleService;
import com.wxs.system.service.ISysUserService;
import com.wxs.system.service.PhoneCodeService;
